...
import { Save, X, Loader2, Trash2, Edit3, Sparkles } from 'lucide-react';
...
export const JournalPanel: React.FC<JournalPanelProps> = ({
  ...
  if (!isEditing) {
    return (
      <div className="journal-card fade-in" style={{ position: 'relative' }}>
        {/* Date */}
  ...
  // ── EDIT MODE ─────────────────────────────────────────────────────────────
  return (
    <div className="journal-card fade-in" style={{ overflow: 'hidden' }}>
      {/* Date */}
      <div className="journal-date">{formatDate(selectedDate)}</div>
      ...
      <div className="ai-box">
        <div className="ai-box-header">
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <Sparkles size={12} color={BRAND.navy} />
